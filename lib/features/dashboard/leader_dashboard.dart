...
class _LeaderDashboardState extends ConsumerState<LeaderDashboard> {
  ...
  Future<bool> showHealthPermissionDialog(BuildContext context) async {
    return await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              ...
              'health and wellness data such as heart rate, steps, and activity '
              'information.\n\n'
              'This data helps provide wellness monitoring, health insights, '
              'and family safety features within the app.\n\n'
              'Your health data is only accessed with your permission and can '
              'be managed at any time through Apple Health settings.',
            ),
            actions: [
              TextButton(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF007F80).withOpacity(.1),
              ...
              Text(
                'Your Family Shield is now active. Let’s take a few moments to build a safer and healthier support network for your loved ones.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 15,
              ...
              _StepTile(
                ...
                subtitle:
                    'Connect children, elders, and caregivers to your Family Shield.',
              ),
              ...
              _StepTile(
                ...
                subtitle:
                    'Create medication schedules and reminders for better care.',
              ),
              ...
              _StepTile(
                ...
                subtitle:
                    'Receive wellness updates and stay informed about your loved ones.',
              ),
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      try {
        ...
        final hasSeenOnboarding =
            prefs.getBool('has_seen_leader_onboarding') ?? false;

        if (!hasSeenOnboarding && profile.role == 'leader') {
...
class _StepTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, color: const Color(0xFF007F80), size: 24),
        const SizedBox(width: 12),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
